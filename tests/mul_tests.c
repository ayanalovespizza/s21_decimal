...
Suite *mul_suite() {
  ...
  TCase *mul_tests = tcase_create("MUL");
  suite_add_tcase(s, mul_tests);
  tcase_add_test(mul_tests, tests_mul_manual1);
  tcase_add_test(mul_tests, tests_mul_manual2);
  tcase_add_test(mul_tests, tests_mul_manual3);
  tcase_add_test(mul_tests, tests_mul_manual4);
  tcase_add_test(mul_tests, tests_mul_manual5);
  tcase_add_test(mul_tests, tests_mul_manual6);
  tcase_add_test(mul_tests, tests_mul_manual7);
  tcase_add_test(mul_tests, tests_mul_manual8);
  tcase_add_test(mul_tests, tests_mul_manual9);
  tcase_add_test(mul_tests, tests_mul_manual10);
  tcase_add_test(mul_tests, tests_mul_manual11);
  tcase_add_test(mul_tests, tests_mul_manual12);
  tcase_add_test(mul_tests, tests_mul_manual13);

  tcase_add_test(mul_tests, tests_mul_manual16);
  tcase_add_test(mul_tests, tests_mul_manual17);

  tcase_add_test(mul_tests, tests_mul17);
  tcase_add_test(mul_tests, tests_mul18);
  tcase_add_test(mul_tests, tests_mul19);
  tcase_add_test(mul_tests, tests_mul20);
  tcase_add_test(mul_tests, tests_mul21);
  tcase_add_test(mul_tests, tests_mul22);
  tcase_add_test(mul_tests, tests_mul23);
  tcase_add_test(mul_tests, tests_mul24);
  tcase_add_test(mul_tests, tests_mul25);
  tcase_add_test(mul_tests, tests_mul26);
  tcase_add_test(mul_tests, tests_mul27);
  tcase_add_test(mul_tests, tests_mul28);
  tcase_add_test(mul_tests, tests_mul29);
  tcase_add_test(mul_tests, tests_mul30);
  tcase_add_test(mul_tests, tests_mul31);
  tcase_add_test(mul_tests, tests_mul32);
  tcase_add_test(mul_tests, tests_mul33);
  tcase_add_test(mul_tests, tests_mul34);
  tcase_add_test(mul_tests, tests_mul35);
  tcase_add_test(mul_tests, tests_mul36);

  tcase_add_test(mul_tests, tests_mul37);
  tcase_add_test(mul_tests, tests_mul38);
  tcase_add_test(mul_tests, tests_mul39);
  tcase_add_test(mul_tests, tests_mul40);
  tcase_add_test(mul_tests, tests_mul41);
  tcase_add_test(mul_tests, tests_mul42);
  tcase_add_test(mul_tests, tests_mul43);
  tcase_add_test(mul_tests, tests_mul44);
  tcase_add_test(mul_tests, tests_mul45);
  tcase_add_test(mul_tests, tests_mul46);
  tcase_add_test(mul_tests, tests_mul47);
  tcase_add_test(mul_tests, tests_mul48);
  tcase_add_test(mul_tests, tests_mul49);
  tcase_add_test(mul_tests, tests_mul50);
  tcase_add_test(mul_tests, tests_mul51);
  tcase_add_test(mul_tests, tests_mul52);
  tcase_add_test(mul_tests, tests_mul53);
  tcase_add_test(mul_tests, tests_mul1820);
  tcase_add_test(mul_tests, tests_mul1821);

  tcase_add_test(mul_tests, tests_mul1821);
  tcase_add_test(mul_tests, tests_mul1822);
  tcase_add_test(mul_tests, tests_mul1823);
  tcase_add_test(mul_tests, tests_mul1824);
  tcase_add_test(mul_tests, tests_mul1825);
  tcase_add_test(mul_tests, tests_mul1826);
  tcase_add_test(mul_tests, tests_mul1827);
  tcase_add_test(mul_tests, tests_mul1828);
  tcase_add_test(mul_tests, tests_mul1829);
  tcase_add_test(mul_tests, tests_mul1830);
  tcase_add_test(mul_tests, tests_mul1831);
  tcase_add_test(mul_tests, tests_mul1832);
  tcase_add_test(mul_tests, tests_mul1833);
  tcase_add_test(mul_tests, tests_mul1834);
  tcase_add_test(mul_tests, tests_mul1835);
  tcase_add_test(mul_tests, tests_mul1836);
  tcase_add_test(mul_tests, tests_mul1837);
  tcase_add_test(mul_tests, tests_mul1838);
  tcase_add_test(mul_tests, tests_mul1839);
