...
START_TEST(is_greater_or_equal_test9) {
  ...
  ck_assert_int_eq(s21_is_greater_or_equal(value_1, value_2), 0);  // correct 1
  ck_assert_int_eq(s21_is_greater_or_equal(value_2, value_1), 1);  // correct 0
}
END_TEST
...
START_TEST(is_greater_or_equal_test10) {
  ...
  ck_assert_int_eq(s21_is_greater_or_equal(value_1, value_2), 1);  // 0
  ck_assert_int_eq(s21_is_greater_or_equal(value_2, value_1), 0);  // 1
}
END_TEST
